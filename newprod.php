...
<center><br><br><br><br>
<font size="+2">New Fixed Price Product Registration <br><br></font>
<form action="insert.php" method="post">
<table border="0"  width="97%" height="35%" align="center" bgcolor="white" class="tbl">
<tr class="tblhd"><td></td><td align="center">Product Name</td><td align="center">Unit Price</td><td align="center">Unit Selling Cost</td><td></td><tr>
<tr><td><input type="reset" name="sub" Value="Clear"></td><td><input type="text" name="pnm" ></td><td><input type="text" name="up" ></td><td><input type="text" name="ucst" ></td><td><input type="submit" name="prd" Value="Regist"></td><tr>
 
 <tr><td align="left" colspan="2"><a href="success.php"> <font color="blue" size="+1" >Back</a></font>

     </font>
   <font color="red" size="+1"><?PHP
