...
<center><br><br><br><br>
<font size="+2">Variable Priced Bought Product Recording <br><br></font>
<form action="insert.php" method="post">
<table border="0"  width="82%" height="35%" align="center" bgcolor="white" class="tbl">
<tr class="tblhd"><td></td><td align="center">Product Name</td><td align="center">Unit Price</td><td align="center">Quantity</td><td></td><tr>
...
</td><td><input type="text" name="qty" ></td><td><input type="submit" name="bv" Value="Regist"></td><tr>
