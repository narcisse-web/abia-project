...
$result = mysql_query("SELECT dfname,dlname,class, amt  FROM debts order by did desc");
?>
<!DOCTYPE html>
<html>
<meta charset="UTF-8">
...
<tr class="listheader">
<td colspan="5" class="h"><center>Debts</center></td>
</tr>
...
<td class="h"><input type="checkbox" name="users[]" value="<?php echo $row["did"]; ?>" ></td>
